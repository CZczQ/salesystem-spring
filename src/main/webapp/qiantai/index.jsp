...
<div class="block clearfix">
	...
	<div class="AreaL">
		...
		<div class="cart" id="ECS_CARTINFO">
 			<a href="flow.php.htm" title="查看购物车">您的购物车中有 ${amounts} 件商品，总计金额 ￥${balances}元。</a>
		</div>
		<div class="blank5"></div>
		<!--左侧分类栏-->
		<div class="box">
 			<div class="box_1">
  				<div id="category_tree">
					<c:forEach items="${types}" var="type">
         			<dl>
     					<dt>
							<a href="${pageContext.request.contextPath}/qiantai/svl/open?type=${type}">${type}</a>
						</dt>
	       			</dl>
					</c:forEach>
  				</div>
					...
					<c:forEach items="${goods}" var="good">
      				<div class="goodsItem">
         				<span class="best"></span>
           				<a href="${pageContext.request.contextPath}/qiantai/svl/addGood?id=${good.id}">
							<img src="${pageContext.request.contextPath}/qiantai/svl/img?pic=${good.pic}" alt="测试商品1" class="goodsimg" /></a>
