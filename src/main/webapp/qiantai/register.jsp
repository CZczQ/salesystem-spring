...
<script>
	...
	function checkUserNameValue(val){
		if(val==""){
			...
			document.getElementById("username_notice").innerHTML="<img src='/qiantai/images/icon_gou.gif'/>";
		}
	}
	...
	function checkEmailValue(val){
		if(val==""){
			...
			document.getElementById("email_notice").innerHTML="<img src='/qiantai/images/icon_gou.gif'/>";
		}
	}	
</script>
</head>
...
<div class="usBox">
	<div class="usBox_2 clearfix">
		...
		<form action="/qiantai/vipsvl/register" method="post" name="formUser" onsubmit="checkForm()" >
